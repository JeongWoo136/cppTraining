...
//브릿지 패턴
// 한가지 카테고리를 멤버 포인터로 만든다.
//즉 vehicle클래스를 상속받는 gaspoweredVehicle, elecpoweredVehicle을 만드는 대신
//engine* 멤버변수를 갖게하고 이것을 engine파생클래스인 gasEngine, elecEngine을 가리키게 하는 것.

//중첩된 일반화
/*
Vehicle
landVehicle, waterVehicle ..
GasPoweredLandVehicle, NuclearPowerLandVehicle ..
계속해서 파생시키는 것.
*/

//다중 상속
/*
GasPoweredLandVehicle은 GasPoweredEngine과 LandVehicle을 둘다 상속 받는것.
